...
class Config:
    ...
    YOUTUBE_API_KEY = os.environ.get(
        "YOUTUBE_API_KEY", "AIzaSyAG1DQIrpE2nUbzOzYJ8_oS7f8AcU4Thvc"
    )
    """
    ...
    REDDIT_CLIENT_SECRET = os.environ.get(
        "REDDIT_CLIENT_SECRET", "UDN2ZasREkEfEtFbvGHhqgGKBMOIuA"
    )
    ...
    BRAVE_SEARCH_API_KEY = os.environ.get(
        "BRAVE_SEARCH_API_KEY", "BSAXrrHvaG5TWPIaJeCGJXhxVRXGuRH"
    )
    """
...
ollama_manager_instance = OllamaConnectionManager(
    Config.OLLAMA_BASE_URL, Config.LLM_GENERATION_OPTIONS
)
...
config.L3_EDGE_SYSTEM_PROMPT = L3_EDGE_SYSTEM_PROMPT
